          ...
          <BrowserRouter>
            <Routes>
              <Route path='/' element={<PrivateLayout />}>
                ...
                <Route
                  path='/usuarios'
                  element={<IndexUsuarios _id={userData._id} />}
                />
                <Route
                  path='/usuario'
                  element={<PerfilUsuario _id={userData._id} />}
                />
                <Route
                  path='/usuarios/editar/:_id'
                  element={<EditarUsuario _id={userData._id} />}
                />
                <Route
                  path='/usuarios/cambiarEstado/:_id'
                  element={
                ...
                <Route
                  path='/proyecto/:_id'
                  element={<Proyecto _id={userData._id} />}
                />
                <Route
                  path='/proyecto/inscripcion/:_id'
                  element={<Inscripcion idUsuario={userData._id} />}
                />
                <Route
                  path='/proyectos/editar/:_id'
                  element={<EditarProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/crear/:_id'
                  element={<CrearProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/aprobar/:_id'
                  element={<AprobarProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/inactivar/:_id'
                  element={<InactivarProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/reabrir/:_id'
                  element={<ReabrirProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/terminar/:_id'
                  element={<TerminarProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/AgregarAvance/:_id'
                  element={<AgregarAvance _id={userData._id} />}
                />
                <Route
                  path='/proyectos/EditarAvance/:_id'
                  element={<EditarAvance _id={userData._id} />}
                />
                <Route
                  path='/proyectos/estado/:_id'
                  element={<EditarProyecto _id={userData._id} />}
                />
                <Route
                  path='/proyectos/avances'
                  element={<Avances _id={userData._id} />}
                />
                <Route
                  path='/proyectos/avances/observacion/:_id'
                  element={<AgregarObservacion _id={userData._id} />}
                />
                <Route
                  path='/proyectos/avances/nuevaObservacion/:_id'
                  element={<NuevaObservacion _id={userData._id} />}
                />
                <Route
                  path='/proyectos/inscripciones'
                  element={
                    <Inscripciones
                      nombre={userData.nombre}
                      _id={userData._id}
                ...
                />
                <Route
                  path='/proyectos/inscripciones/estado/:_id'
                  element={<EstadoInscripcion _id={userData._id} />}
                />
              </Route>
